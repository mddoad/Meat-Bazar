    ...
    <div class="container">
        ...
        <div class="content">
            <div class="contact-card">
                ...
                <div class="contact-admin"><span class="contact-label">Admin:</span> MD Doad</div>
                <div class="contact-info"><span class="contact-label">Phone:</span> 01568171665</div>
                <div class="contact-info"><span class="contact-label">Email:</span> doadmd@gmail.com</div>
                <div class="contact-info"><span class="contact-label">WhatsApp:</span> 01648076092</div>
